ORG 0000H
SETB P0.0;              CONFIGURE PIN P0.0
SETB P0.1;              CONFIGURE PIN P0.1
SETB P0.2;              CONFIGURE PIN P0.2
READY :MOV C,P0.0;      READING PIN P0.1 WHER ETHE FIRST SWITCH IS CONNECTED
...
CHECK1 :MOV C,P0.1;     READ THE NEXT PIN(P0.1)
