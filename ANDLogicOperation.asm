ORG 0000H
SETB P0.0;              CONFIGURE PIN P1.0
SETB P0.1;              CONFIGURE PIN P1.1
SETB P0.2;              CONFIGURE PIN P1.2
READY :MOV C,P0.0;      READING PIN P1.1 WHER ETHE FIRST SWITCH IS CONNECTED
...
CHECK1 :MOV C,P0.1;     READ THE NEXT PIN(P1.1)
JNC CHECK2;             IF CARRY IS RESET JUMP TO CHECK2
SJMP READY;             IF THE CARRY IS RESET JUMP TO READY
CHECK2 :CLR P0.2;       THE CODE FLOW COMES TO THIS LIN ONLY IF BOTH THE PORT PINS ARE 1. IF SO THE LED WILL TURN ON
ACALL DELAY;            TO PRODUCE DELAY
SETB P0.2;              TURNING OFF THE LED
LJMP READY;             REPEAT THE READING PROCCESS
DELAY :MOV R7,#0X0FH;    DELAY PROGRAM BY COUNTING
LOOP :DJNZ R7,LOOP;
RET;
END; 
